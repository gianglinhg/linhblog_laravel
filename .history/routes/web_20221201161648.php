...
Route::prefix('auth')->name('auth.')->group(function(){
    ...
    Route::post('/forgot-password',[LoginController::class,'post_forgot_password'])->name('password.email');

    Route::get('/reset-password/{token}', [LoginController::class, 'reset_password'])
              ->name('password.reset');
  Route::post('/reset-password', [LoginController::class, 'post_reset_password'])
              ->name('password.store');
