  ...
  <div class="blog-list clearfix">
    ...
    <div class="blog-box row">
        <div class="col-md-4">
            <div class="post-media">
                <a href="tech-single.html" title="">
                    <img src="/template/{{$tin->urlHinh}}" alt="" class="img-fluid">
        ...
        <div class="blog-meta big-meta col-md-8">
            ...
            <p>{{$tin->tomTat}}</p>
            <small class="firstsmall"><a class="bg-orange" href="#" title="">{{$tin->ten}}</a></small>
            <small><a href="#">{{date("d-m-Y", strtotime($tin->ngayDang))}}</a></small>
    ...
    @endforeach
      ...
      <div class="blog-box row">
          ...
          <div class="blog-meta big-meta col-md-8">
              ...
              <small><a href="#" title="">{{date("d-m-Y", strtotime($tin->ngayDang))}}</a></small>
              {{-- <small><a href="#" title="">by LinhG</a></small> --}}
              <small><a href="#" title=""><i class="fa fa-eye"></i> {{$tin->xem}}</a></small>
          </div><!-- end meta -->
      </div><!-- end blog-box -->
