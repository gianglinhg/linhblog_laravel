                          ...
                          <div class="container">
                              <div class="mega-menu-content clearfix">
                                {{-- @foreach ($loaitin_arr as $loaitin)
                                    <div class="tab">
                                        <button class="tablinks"><a href="{{url('/loai',[$loaitin->id])}}">{{$loaitin->ten}}</a></button>
                                    </div>
                                    @endforeach --}}
                                {{-- @foreach ($loaitin_arr as $loaitin) --}}
                                  <div class="tab">
                                      <button class="tablinks active" onclick="openCategory(event, 'cat01')">{{$loaitin_arr[0]->ten}}</button>
                                      <button class="tablinks" onclick="openCategory(event, 'cat02')">{{$loaitin_arr[1]->ten}}</button>
                                      <button class="tablinks" onclick="openCategory(event, 'cat03')">{{$loaitin_arr[2]->ten}}</button>

                                      <button class="tablinks" onclick="openCategory(event, 'cat04')">{{$loaitin_arr[3]->ten}}</button>

                                      <button class="tablinks" onclick="openCategory(event, 'cat05')">{{$loaitin_arr[4]->ten}}</button>
                                    </div>
                                {{-- @endforeach --}}
