...
<div class="container-fluid">
  <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
                                                  ...
                                                  <div class="blog-box">
                                                      <div class="post-media">
                                                          <a href="tech-single.html" title="">
                                                              <img src="/template/{{$item->urlHinh}}" alt="" class="img-fluid">
                                                      ...
                                                      <div class="blog-meta">
                                                          <h4><a href="tech-single.html" title="">{{$item->tieuDe}}</a></h4>
                                                      </div><!-- end meta -->
                                                  </div><!-- end blog-box -->
                                              </div>
                                              @endforeach
          ...
          <ul class="navbar-nav mr-2">
              <li class="nav-item">
                  <a class="nav-link" href="{{route('admin.')}}"><i class="fa-regular fa-lock"></i></a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="{{route('auth.register')}}"><i class="fa-solid fa-user-plus"></i></a>
              </li>
              {{-- <li class="nav-item">
