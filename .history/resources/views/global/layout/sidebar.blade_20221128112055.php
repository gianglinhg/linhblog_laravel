<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="{{route('auth.dashboard')}}" class="d-block"><p class="fs-5">{{Auth::user()->name}}
          (
            @if(Auth::user()->id_group == 1) Quản trị viên @endif
            @if(Auth::user()->id_group != 1) Thành viên @endif
        )</p></a>
      </div>
    </div>
