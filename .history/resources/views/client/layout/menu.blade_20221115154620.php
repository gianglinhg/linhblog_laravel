...
<div class="container-fluid">
  <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
      ...
      <a class="navbar-brand" href="/home"><img src="images/version/tech-logo.png" alt=""></a>
      <div class="collapse navbar-collapse" id="navbarCollapse">
                          ...
                          <div class="container">
                              <div class="mega-menu-content clearfix">
                                @foreach ($loaitin_arr as $loaitin)
                                    ...
                                    @endforeach
                                  {{-- <div class="tab">
                                      <button class="tablinks active" onclick="openCategory(event, 'cat01')">cat1</button>
                                      <button class="tablinks" onclick="openCategory(event, 'cat02')">cat2</button>
                                    </div> --}}
          ...
          <ul class="navbar-nav mr-2">
              <li class="nav-item">
                  <a class="nav-link" href="../admin"><i class="fa-regular fa-lock"></i></a>
              </li>
              {{-- <li class="nav-item">
