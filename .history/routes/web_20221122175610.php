...
Route::prefix('admin')->group(function (){
    ...
    Route::prefix('loaitin')-name('loaitin.')->group(function(){
        Route::get('/list',[QueryController::class,'list'])->name('list');
        Route::get('/add',[QueryController::class,'add'])->name('add');
        Route::post('/add',[QueryController::class,'postAdd'])->name('post-add');
        Route::get('/edit/{id}',[QueryController::class,'edit'])->name('edit');
        Route::post('/update',[QueryController::class,'postEdit'])->name('post-edit');
        Route::get('/delete/{id}',[QueryController::class,'delete'])->name('delete');
    })
});
