                            ...
                            <div class="blog-list clearfix">
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        ...
                                        <p>{{$tin->tomTat}}</p>
                                        <small class="firstsmall"><a class="bg-orange">Reviews</a></small>
                    <small><a href="{{ url('/tin',[$tin->id]); }}">{{date("d-m-Y", strtotime($tin->ngayDang))}}</a></small>
                                        <small><a href="{{ url('/tin',[$tin->id]); }}">
                                            <i class="fa fa-eye"></i> {{$tin->xem}}</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end blog-box -->
...
@endsection
@section('panigate')
    {{ $listin->links('client.layout.panigate') }}
@endsection