...
class AuthController extends Controller
{
    ...
    public function post_register(Request $request){
        ...
        $request->validate([
            ...
            'password' => ['required',"regex:'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{9,}$'"],
            ...
            'password.regex' => 'Mật khẩu phải có 9 ký tự và chữ thường, chữ hoa,số',
    ...
    public function post_password(Request $request){
        $request->validate([
            ...
            'new_password' => ['required',"regex:'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{9,}$'"],
            ...
            'new_password.regex' => 'Mật khẩu mới phải có 9 ký tự và chữ thường, chữ hoa,số',
