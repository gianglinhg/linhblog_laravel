...
@section('content')
    <div class="row m-2">
        <div class="col-8">
            <form action="" class="row d-flex align-items-center" method="get">
                <div class="col-5">
                    <select name="loaitin" id="" class="form-control">
                ...
                <div class="col-2">
                    <button type="submit" class="btn btn-primary btn-inline ">Tìm</button>
                </div>
            </form>
        </div>
