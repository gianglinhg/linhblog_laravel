  ...
  <div class="masonry-box post-media">
       ...
       <div class="shadoweffect">
          <div class="shadow-desc">
              <div class="blog-meta">
                  <span class="bg-orange"><a href="#" title="">{{$noibat[0]->ten}}</a></span>
...
<div class="second-slot">
  <div class="masonry-box post-media">
       ...
       <div class="shadoweffect">
          <div class="shadow-desc">
              <div class="blog-meta">
                  <span class="bg-orange"><a href="#" title="">{{$noibat[1]->ten}}</a></span>
...
<div class="last-slot">
  <div class="masonry-box post-media">
       ...
       <div class="shadoweffect">
          <div class="shadow-desc">
              <div class="blog-meta">
                  <span class="bg-orange"><a href="#" title="">{{$noibat[2]->ten}}</a></span>
