...
class TinController extends Controller
{
    ...
    public function index($id=0){
        ...
        return view('client.home', compact('title','sidebarNews','loaitin'),$data);
    }
    public function chitiet($id=0,Request $request){
        ...
        return view('client.chitiet',compact('title','comment','loaitin'), $data);
    }
    public function tintrongloai($id){
        ...
        $title = 'Tin loại ' . $name ;
        return view('client.tintrongloai',compact('title','loaitin'), $data);
    }
    public function search(){
        ...
        if(!($keyword == "")){
            ...
            ->paginate(config('tin.paginate'));
            return view('client.search', compact('searchTin','title','sidebarNews','loaitin'));
        }else{
