...
Route::prefix('tin')->group(function () {
    ...
    Route::get('/list',[TinController::class,'list'])->name('list');
    Route::get('/add',[TinController::class,'add'])->name('add');
    Route::post('/add',[TinController::class,'postAdd'])->name('post-add');
    Route::get('/delete/{id}',[TinController::class,'delete'])->name('delete');
    Route::get('/update/{id}',[TinController::class,'update'])->name('update');
    Route::post('/update/{id}',[TinController::class,'postUpdate'])->name('post-update');
