                              ...
                              <div class="mega-menu-content clearfix">
                                ...
                                {{-- @foreach ($loaitin as $tin) --}}
                                  <div class="tab">
                                      ...
                                      <button class="tablinks active" onclick="openCategory(event, 'cat02')">
                                        <a href="{{url('/loai',[$loaitin[1]->id])}}">
                                            {{$loaitin[1]->ten}}
                                        </a>
                                    </button>
                                      <button class="tablinks active" onclick="openCategory(event, 'cat03')">
                                        <a href="{{url('/loai',[$loaitin[2]->id])}}">
                                            {{$loaitin[2]->ten}}
                                        </a>
                                    </button>
                                      <button class="tablinks active" onclick="openCategory(event, 'cat04')">
                                        <a href="{{url('/loai',[$loaitin[3]->id])}}">
                                            {{$loaitin[3]->ten}}
                                        </a>
                                    </button>
                                      <button class="tablinks active" onclick="openCategory(event, 'cat05')">
