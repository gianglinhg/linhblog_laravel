                              ...
                              <div class="mega-menu-content clearfix">
                                ...
                                {{-- @foreach ($loaitin_arr as $loaitin) --}}
                                  <div class="tab">
                                      ...
                                      <button class="tablinks" onclick="openCategory(event, 'cat02')">{{$loaitin_arr[2]->ten}}</button>
                                    </div>
                                      <button class="tablinks" onclick="openCategory(event, 'cat02')">{{$loaitin_arr[3]->ten}}</button>
                                    </div>
                                      <button class="tablinks" onclick="openCategory(event, 'cat02')">{{$loaitin_arr[4]->ten}}</button>
                                    </div>
                                {{-- @endforeach --}}
