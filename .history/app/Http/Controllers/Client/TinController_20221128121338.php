...
class TinController extends Controller
{
    ...
    public function chitiet($id=0){
        ...
        $haynhat = $this->haynhat;
        $data = ['id' => $id, 'tin' => $tin,'haynhat'=>$haynhat];
    ...
    public function tintrongloai($id){
        ...
        $data = ['id' => $id, 'name' => $name,'listin'=>$listin,'haynhat'=>$haynhat];
        $title = 'Tin loại ' . $name ;
    ...
    public function search(){
        ...
        if(!($keyword == "")){
            ...
            ->paginate(config('tin.paginate'));
            return view('client.search', compact('searchTin','title','haynhat'));
        }else{
