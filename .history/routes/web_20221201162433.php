...
Route::prefix('auth')->name('auth.')->group(function(){
    ...
    Route::get('/forgot-password',[MailController::class,'forgot_password'])->name('password.store');
    Route::post('/forgot-password',[MailController::class,'post_forgot_password'])->name('password.request');

    Route::get('/reset-password/{token}', [MailController::class, 'reset_password'])
              ->name('password.reset');
    Route::post('/reset-password', [MailController::class, 'post_reset_password'])
              ->name('password.store');
    ...
    Route::get('delete/comment/{id}',[CommentController::class,'deleteCmt'])
    ->name('deleteCmt');
});
