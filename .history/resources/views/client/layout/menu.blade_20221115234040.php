                      ...
                      <li>
                          <div class="container">
                              <div class="mega-menu-content clearfix">
                                ...
                                @foreach ($loaitin as $tin)
                                  <div class="tab">
                                      <button class="tablinks active" onclick="openCategory(event, 'cat01')">{{$tin[0]->ten}}</button>
                                      {{-- <button class="tablinks" onclick="openCategory(event, 'cat02')">{{$tin[1]->ten}}</button>
                                      <button class="tablinks" onclick="openCategory(event, 'cat03')">{{$tin[2]->ten}}</button>

                                      <button class="tablinks" onclick="openCategory(event, 'cat04')">{{$tin[3]->ten}}</button>

                                      <button class="tablinks" onclick="openCategory(event, 'cat05')">{{$tin[4]->ten}}</button> --}}
                                    </div>
                                @endforeach
