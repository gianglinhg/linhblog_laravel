                      ...
                      <li>
                          <div class="container">
                              <div class="mega-menu-content clearfix">
                                ...
                                {{-- @foreach ($loaitin as $loaitin) --}}
                                  <div class="tab">
                                      <button class="tablinks active" onclick="openCategory(event, 'cat01')">{{$loaitin[0]->ten}}</button>
                                      <button class="tablinks" onclick="openCategory(event, 'cat02')">{{$loaitin[1]->ten}}</button>
                                      <button class="tablinks" onclick="openCategory(event, 'cat03')">{{$loaitin[2]->ten}}</button>

                                      <button class="tablinks" onclick="openCategory(event, 'cat04')">{{$loaitin[3]->ten}}</button>

                                      <button class="tablinks" onclick="openCategory(event, 'cat05')">{{$loaitin[4]->ten}}</button>
                                    </div>
                                {{-- @endforeach --}}
