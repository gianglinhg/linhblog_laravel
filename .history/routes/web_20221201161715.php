...
Route::prefix('auth')->name('auth.')->group(function(){
    ...
    Route::get('/forgot-password',[MailController::class,'forgot_password'])->name('forgot_password');
    Route::post('/forgot-password',[MailController::class,'post_forgot_password'])->name('password.email');
